".lg==============================
autocmd FileType lg inoremap ,, [ ]<Tab>
autocmd FileType lg inoremap ,p <Esc>:s/\[\s\]/\[p\]/<Enter>a
autocmd FileType lg inoremap ,x <Esc>:s/\[\s\]/\[x\]/<Enter>a
autocmd FileType lg inoremap ,+ <Esc>:s/\[\s\]/\[*\]/<Enter>a
autocmd FileType lg inoremap ,? <Esc>:s/\[\s\]/\[?\]/<Enter>a
